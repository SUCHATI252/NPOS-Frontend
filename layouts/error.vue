    ...
    <div class="container">
      <div class="left-section">
        <div class="inner-content">
          ...
          <p class="subheading">
            {{ error.statusCode === 404 ? $t('error.pageNotFound') : $t('error.otherError') }}
          </p>
          <br>
          <p class="text-center">
            <v-btn color="primary" to="/" v-text="$t('error.goHome')" />
          </p>
        </div>
      </div>
...
export default {
  ...
  head () {
    const title =
      this.error.statusCode === 404 ? this.$t('error.pageNotFound') : this.$t('error.otherError')
    return {
      title
    }
  }
